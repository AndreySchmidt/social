  ...
  return (
    ...
    <div className="main_content">
        ...
        <div className="c_header_section_title">
            <Link className="c_button_large link_right" to="">Добавить список расходов</Link>
        ...
        <div className="content_container">
            ...
            <div className="calculator_header">
                <Link className="back" to="">Вернуться к спискам</Link>
            ...
            <div className="c_calculator_table">
                ...
                <div className="row">
                    <div className="name row_title cell">
                        Банкет
                    </div>
                    <div className="price cell">
                        &nbsp;
